...
export const autoSeedIfEmpty = async () => {
  try {
    ...
    if (userCount > 0) {
      console.log('[AutoSeed] Database already populated. Skipping auto-seed.');
      return;
    }

    console.log('[AutoSeed] Fresh database detected (0 users). Initializing default database schema...');
    ...
    console.log('[AutoSeed] Created default users: admin/admin123, cashier/cashier123');
    ...
    console.log('[AutoSeed] Initial database setup completed! Default login: admin/admin123');
  } catch (err) {
